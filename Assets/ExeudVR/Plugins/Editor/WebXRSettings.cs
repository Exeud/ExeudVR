...
{
  [System.Serializable]
  internal class WebXRSettings : ScriptableObject
  {
    ...
    [Header("VR Settings")]
    public ReferenceSpaceTypes VRRequiredReferenceSpace = ReferenceSpaceTypes.local;
    public ExtraFeatureTypes VROptionalFeatures = 0;

        [Header("AR Settings")]
    public ReferenceSpaceTypes ARRequiredReferenceSpace = ReferenceSpaceTypes.local;
    public ExtraFeatureTypes AROptionalFeatures = 0;
...
Default is 1.0, the recommended resolution.")]
    ...
    public bool AutoLoadWebXRManager = false;
...
WebXRInputSystem is part of WebXR Interactions package.")]
    public bool AutoLoadWebXRInputSystem = false;
