...
public class Mirror : MonoBehaviour
{
    ...
    void UpdateCamera(ScriptableRenderContext SRC, Camera camera)
    {
        if ((camera.cameraType == CameraType.Game || camera.cameraType == CameraType.SceneView) &&
            camera.tag != "ReflectCam") // is the current camera eligeble for portalling?
        {
    ...
    private void CreatePortalCamera(Camera currentCamera, Camera.StereoscopicEye eye, out Camera portalCamera, ref RenderTexture portalTexture)
    {
        ...
        {
            GameObject go = new GameObject("Mirror Reflection Camera id" + GetInstanceID(), typeof(Camera), typeof(Skybox)); // create the new game object
            ...
            portalCamera.tag = "ReflectCam"; // Tag it as a portal camera so it doesn't participate in the additional CameraRender function
